## ![](../../images/icons/Get_Zone_EnergyPlus_Loads.png) Get Zone EnergyPlus Loads - [[source code]](https://github.com/ladybug-tools/honeybee-legacy/tree/master/src/Honeybee_Get%20Zone%20EnergyPlus%20Loads.py)
