## ![](../../images/icons/OpenFileDirectory.png) OpenFileDirectory - [[source code]](https://github.com/ladybug-tools/honeybee-legacy/tree/master/src/Honeybee_OpenFileDirectory.py)
